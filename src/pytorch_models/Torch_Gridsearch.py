...
def main(dataset, runid, num_neurons=50, num_epochs=300, epochs=[200, 250], 
    ...
    def logging(where=None):
        ...
        saveplot(plot_actual_vs_predicted_full(data, predicted, num_feat=num_feat, info=(epoch, loss, dataset), toy=False, for_torch=True), "FullPredictions") #TODO add args for subtitle
